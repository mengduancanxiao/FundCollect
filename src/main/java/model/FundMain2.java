...
public class FundMain2 {
    private String fundcode;//代号
    private String name;//名称
    private String jzrq;//昨日日期
    private String dwjz;//昨日净值
    private String gsz;//今日净值
    private String gszzl;//涨跌幅
    private String gztime;//今日日期
